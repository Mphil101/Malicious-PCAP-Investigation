...
![IP:10.2.28.88 packets](<screenshots/Screenshot of packets in victim's machine.png>)
...
![TCP Stream/HTTP Post](<screenshots/Screenshot of httpPost of malicious software.png>)
*Wireshark showing TCP stream 40 and remote-server user-agent*
...
- MAC: 14:b3:1f:2d:ce:69
  ...
  *Used NetBIOS filter to find the name of compromised machine*
...
![UserName](<screenshots/Screenshot of using Kerberos to find user name.png>)
*Used Kerberos.CNameString filter to find the username of Hostname: DESKTOP-TEYQ2NR*
...
![using username](<screenshots/Screenshot of find packet to find full name.png>)
*After finding the username, filtered out packets by using last name "Rolf"*
...
![fullname](<screenshots/Screenshot of full name of user.png>)
*By using last name "Rolf", the full name belonging to "brolf" was "Becka Rolf"*
